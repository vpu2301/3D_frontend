        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[color:var(--ink)] mb-4">Core AI Modules</h2>
              <p className="text-lg text-[color:var(--text-2)]">Available in all plans from day one</p>
            </div>
              ...
              {coreModules.map((module, index) => (
                <Card key={index} className="shadow-lg hover:shadow-xl transition-shadow border-0 overflow-hidden">
                  ...
                  <CardContent className="p-6">
                    <p className="text-[color:var(--text-2)] mb-6">{module.description}</p>
                    <div className="grid grid-cols-2 gap-2">
                      {module.features.map((feature, featureIndex) => (
                        <div key={featureIndex} className="flex items-center text-sm text-[color:var(--ink)]">
          ...
          {/* Benefits Section */}
          <section className="mb-20 bg-[color:var(--sand)] -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[color:var(--ink)] mb-4">Why SMBs Choose MarketMind AI</h2>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {benefits.map((benefit, index) => (
                <Card key={index} className="text-center border-0 shadow-sm bg-[color:var(--paper)]">
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-xl font-semibold text-[color:var(--ink)] mb-2">{benefit.title}</h3>
                    <p className="text-[color:var(--text-2)]">{benefit.description}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[color:var(--ink)] mb-4">Coming Soon</h2>
              <p className="text-lg text-[color:var(--text-2)]">Advanced features in development</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {futureModules.map((module, index) => (
                <Card key={index} className="border border-[color:var(--line)] hover:shadow-md transition-shadow">
                  <CardContent className="p-6 text-center">
                    <div className="w-12 h-12 bg-[color:var(--sand)] rounded-[16px] flex items-center justify-center mx-auto mb-4">
                      <module.icon className="h-6 w-6 text-[color:var(--text-2)]" />
                    </div>
                    <h3 className="font-semibold text-[color:var(--ink)] mb-2">{module.title}</h3>
                    <p className="text-sm text-[color:var(--text-2)] mb-3">{module.description}</p>
                    <div className="text-xs bg-[color:var(--blue-100)] text-[color:var(--blue)] px-2 py-1 rounded-full">
                      {module.timeline}
                    </div>
                  </CardContent>
                </Card>
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[color:var(--ink)] mb-4">Built for European SMBs</h2>
              <p className="text-lg text-[color:var(--text-2)]">Privacy-first, multilingual, and compliant</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[color:var(--ink)] mb-2">GDPR Compliant</h3>
                <p className="text-[color:var(--text-2)]">EU hosting, SOC-2 certified, per-tenant encryption</p>
              </div>
              
              <div className="text-center">
                <div className="w-16 h-16 bg-[color:var(--blue-100)] rounded-full flex items-center justify-center mx-auto mb-4">
                  <Globe className="h-8 w-8 text-[color:var(--blue)]" />
                </div>
                <h3 className="text-lg font-semibold text-[color:var(--ink)] mb-2">Multilingual</h3>
                <p className="text-[color:var(--text-2)]">Native support for 12+ European languages</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-[color:var(--ink)] mb-2">High Performance</h3>
                <p className="text-[color:var(--text-2)]">80%+ gross margin with proprietary AI models</p>
              </div>
            </div>
          </section>

          {/* CTA Section */}
          <div className="bg-[color:var(--paper)] rounded-[28px] p-12 text-center border border-[color:var(--line)]">
            <h2 className="text-3xl font-bold text-[color:var(--ink)] mb-4">Ready to Automate Your Marketing?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-[color:var(--ink)] text-white hover:bg-[color:var(--text-2)] rounded-full" asChild>
                <Link to="/signup">
                  Start 14-Day Free Trial
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="border-[color:var(--line)] bg-[color:var(--paper)] text-[color:var(--ink)] hover:bg-[color:var(--paper)] rounded-full" asChild>
                <Link to="/watch-demo">
                  Watch Demo
                </Link>
              </Button>
