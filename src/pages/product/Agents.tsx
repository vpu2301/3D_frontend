  ...
  return (
    <div className="min-h-screen pt-20 bg-gradient-to-b from-[color:var(--sand)] to-[color:var(--paper)] dark:from-[color:var(--bg)] dark:to-[color:var(--paper)]">
      ...
      <section className="py-20 px-4 bg-[color:var(--paper)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[color:var(--ink)] mb-6">Agent Capabilities</h2>
      ...
      <section className="py-20 px-4 bg-[color:var(--sand)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[color:var(--ink)] mb-6">Specialized Agent Types</h2>
            <p className="text-xl text-[color:var(--text-2)] max-w-3xl mx-auto">
            ...
            {agentTypes.map((agent, index) => (
              <div key={index} className="bg-[color:var(--paper)] p-8 rounded-[28px] shadow-lg">
                <div className="flex items-center mb-4">
                  <div className="p-3 rounded-[28px] bg-gradient-to-r from-[color:var(--blue)] to-[color:var(--text-2)] mr-4">
                    <agent.icon className="h-6 w-6 text-white" />
                  </div>
                  <h3 className="text-xl font-medium text-[color:var(--ink)]">{agent.name}</h3>
                </div>
                <p className="text-[color:var(--text-2)] mb-6">{agent.description}</p>
                <div className="space-y-3 mb-6">
                  {agent.capabilities.map((capability, idx) => (
                    <div key={idx} className="flex items-center">
                      <CheckCircle className="h-5 w-5 text-[color:var(--blue)] mr-3 flex-shrink-0" />
                      <span className="text-[color:var(--ink)]">{capability}</span>
                    </div>
                  ))}
                </div>
      ...
      <section className="py-20 px-4 bg-[color:var(--paper)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[color:var(--ink)] mb-6">Agent Performance</h2>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl font-light text-[color:var(--blue)] mb-2">95%</div>
              <div className="text-[color:var(--text-2)]">Task completion rate</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-light text-[color:var(--blue)] mb-2">24/7</div>
              <div className="text-[color:var(--text-2)]">Continuous operation</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-light text-[color:var(--blue)] mb-2">10x</div>
              <div className="text-[color:var(--text-2)]">Faster than humans</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-light text-[color:var(--blue)] mb-2">99%</div>
              <div className="text-[color:var(--text-2)]">Accuracy rate</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-[color:var(--paper)] rounded-[28px] p-12 text-[color:var(--ink)] border border-[color:var(--line)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-[color:var(--text-2)]">Real-time monitoring and optimization of agent performance</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-[color:var(--text-2)]">Tailor agent behavior to your specific business needs</p>
              </div>
              <div className="text-center">
                <Shield className="h-12 w-12 text-[color:var(--blue)] mx-auto mb-4" />
                <h4 className="text-xl font-medium mb-2">Secure Deployment</h4>
                <p className="text-[color:var(--text-2)]">Enterprise-grade security and compliance features</p>
              </div>
            </div>
          </div>
        </div>
