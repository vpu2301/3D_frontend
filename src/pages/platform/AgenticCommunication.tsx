  ...
  return (
    <div className="min-h-screen pt-20 bg-[color:var(--paper)]">
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-[color:var(--blue-100)] border border-[color:var(--line)] rounded-full px-4 py-2 mb-6">
              <Bot className="h-4 w-4 text-[color:var(--blue)]" />
              <span className="text-[color:var(--blue)] text-sm font-medium">Platform Technology</span>
            </div>
            <h1 className="text-6xl font-light text-[color:var(--ink)] mb-6 tracking-tight">
              Agentic Communication
              <span className="block text-[color:var(--blue)]">Protocol</span>
            </h1>
            <p className="text-xl text-[color:var(--text-2)] max-w-4xl mx-auto font-light leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
              <Button className="bg-[color:var(--blue)] hover:bg-[color:var(--blue)] text-white px-8 py-3 rounded-full" asChild>
      ...
      <section className="py-20 px-4 bg-[color:var(--paper)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[color:var(--ink)] mb-6">Core Communication Features</h2>
      ...
      <section className="py-20 px-4 bg-[color:var(--sand)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[color:var(--ink)] mb-6">Real-World Applications</h2>
            <p className="text-xl text-[color:var(--text-2)] max-w-3xl mx-auto">
            ...
            {useCases.map((useCase, index) => (
              <div key={index} className="bg-[color:var(--paper)] p-8 rounded-[28px] shadow-lg">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-medium text-[color:var(--ink)]">{useCase.title}</h3>
                </div>
                <p className="text-[color:var(--text-2)] mb-6">{useCase.description}</p>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-[color:var(--ink)] mb-3">Participating Agents:</p>
      ...
      <section className="py-20 px-4 bg-[color:var(--paper)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[color:var(--ink)] mb-6">Technical Specifications</h2>
            <p className="text-xl text-[color:var(--text-2)] max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {technicalSpecs.map((spec, index) => (
              <div key={index} className="bg-[color:var(--sand)] p-8 rounded-[28px]">
                <h3 className="text-xl font-medium text-[color:var(--ink)] mb-6">{spec.title}</h3>
                <ul className="space-y-3">
                  {spec.specs.map((item, idx) => (
                    <li key={idx} className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-[color:var(--blue)] mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[color:var(--text-2)]">{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
      ...
      <section className="py-20 px-4 bg-[color:var(--sand)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[color:var(--ink)] mb-6">Performance & Reliability</h2>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="text-center">
                <div className="text-4xl font-light text-[color:var(--blue)] mb-2">{benefit.metric}</div>
                <div className="text-[color:var(--text-2)]">{benefit.description}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-[color:var(--paper)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[color:var(--ink)] mb-6">Integration Process</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[color:var(--blue-100)] rounded-full flex items-center justify-center mx-auto mb-6">
                <span className="text-2xl font-light text-[color:var(--blue)]">1</span>
              </div>
              <h3 className="text-xl font-medium text-[color:var(--ink)] mb-4">API Integration</h3>
              <p className="text-[color:var(--text-2)]">Connect your AI agents to our communication protocol with simple API calls and authentication setup.</p>
            </div>
            
            <div className="text-center">
              <div className="w-16 h-16 bg-[color:var(--blue-100)] rounded-full flex items-center justify-center mx-auto mb-6">
                <span className="text-2xl font-light text-[color:var(--blue)]">2</span>
              </div>
              <h3 className="text-xl font-medium text-[color:var(--ink)] mb-4">Network Discovery</h3>
              <p className="text-[color:var(--text-2)]">Your agents automatically discover and establish secure connections with authorized partner agents.</p>
            </div>
            
            <div className="text-center">
              <div className="w-16 h-16 bg-[color:var(--blue-100)] rounded-full flex items-center justify-center mx-auto mb-6">
                <span className="text-2xl font-light text-[color:var(--blue)]">3</span>
              </div>
              <h3 className="text-xl font-medium text-[color:var(--ink)] mb-4">Workflow Configuration</h3>
              <p className="text-[color:var(--text-2)]">Define communication patterns, data sharing rules, and collaborative workflows between agent networks.</p>
            </div>
            
            <div className="text-center">
              <div className="w-16 h-16 bg-[color:var(--blue-100)] rounded-full flex items-center justify-center mx-auto mb-6">
                <span className="text-2xl font-light text-[color:var(--blue)]">4</span>
              </div>
              <h3 className="text-xl font-medium text-[color:var(--ink)] mb-4">Live Collaboration</h3>
              <p className="text-[color:var(--text-2)]">Watch as your AI agents seamlessly collaborate across company boundaries in real-time operations.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Security Deep Dive */}
      <section className="py-20 px-4 bg-[color:var(--sand)] text-[color:var(--ink)]">
        <div className="max-w-7xl mx-auto">
          <div className="bg-[color:var(--paper)] rounded-[28px] p-12 border border-[color:var(--line)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-[color:var(--text-2)]">Every agent connection is verified and encrypted, with no implicit trust between network participants.</p>
              </div>
              <div className="text-center">
                <Shield className="h-12 w-12 text-[color:var(--blue)] mx-auto mb-4" />
                <h4 className="text-xl font-medium mb-2">Granular Permissions</h4>
                <p className="text-[color:var(--text-2)]">Fine-grained access control determines exactly what data each agent can access and share.</p>
              </div>
              <div className="text-center">
                <Activity className="h-12 w-12 text-[color:var(--blue)] mx-auto mb-4" />
                <h4 className="text-xl font-medium mb-2">Real-Time Monitoring</h4>
                <p className="text-[color:var(--text-2)]">Continuous monitoring of all agent communications with instant threat detection and response.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[color:var(--sand)] text-[color:var(--ink)] px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-[color:var(--paper)] rounded-full py-3" asChild>
              <Link to="/contact">
