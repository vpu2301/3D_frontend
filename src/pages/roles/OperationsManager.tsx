...
const OperationsManager = () => {
  return (
    <div className="min-h-screen dark:bg-[color:var(--bg)]">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[color:var(--ink)] to-[color:var(--blue-100)] pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex justify-center mb-6">
              <div className="bg-[color:var(--ink)] p-4 rounded-[28px]">
                <Cog className="h-12 w-12 text-white" />
              </div>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-[color:var(--ink)] mb-6">
              AI Solutions for
              <span className="text-[color:var(--ink)] block">Operations Managers</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-[color:var(--ink)] hover:bg-[color:var(--text-2)]" asChild>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="bg-[color:var(--blue-100)] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
                <Cog className="h-8 w-8 text-[color:var(--blue)]" />
              </div>
