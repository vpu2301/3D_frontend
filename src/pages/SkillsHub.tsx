    ...
    <div className="min-h-screen bg-[color:var(--paper)] dark:bg-[color:var(--bg)]">
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[color:var(--blue-100)] border border-[color:var(--line)] text-[color:var(--blue)] text-xs font-medium mb-6 dark:bg-[color:var(--blue-100)] dark:border-[color:var(--line)] dark:text-[color:var(--blue)]" style={{ borderRadius: '28px' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="#browse">
              <button className="px-7 py-3.5 bg-[color:var(--ink)] hover:bg-[#2a2a28] text-white text-sm font-medium transition-all duration-200 flex items-center gap-2 dark:bg-[color:var(--paper)] dark:text-[color:var(--ink)] dark:hover:bg-[color:var(--paper)]" style={{ borderRadius: '9999px' }}>
                Explore the hub
                <ArrowRight className="w-4 h-4" />
              </button>
            </a>
            <a href="#publish">
              <button className="px-7 py-3.5 border border-[color:var(--line)] text-[color:var(--text-2)] hover:text-[color:var(--ink)] hover:border-[color:var(--line)] text-sm font-medium transition-all duration-200 flex items-center gap-2 dark:border-white/15 dark:text-white/60 dark:hover:text-white" style={{ borderRadius: '9999px' }}>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-light text-[color:var(--ink)] dark:text-white mb-3">Four building blocks</h2>
            <p className="text-[color:var(--text-2)] dark:text-white/45">Mix and match to compose the AI teammate your workflow needs.</p>
          </div>
            ...
            {(Object.keys(kindMeta) as ItemKind[]).map(k => {
              ...
              return (
                <button
                  ...
                  className="text-left p-6 bg-[color:var(--paper)] border border-[color:var(--line)] hover:border-[color:var(--line)] hover:shadow-md hover:-translate-y-0.5 transition-all dark:bg-[color:var(--paper)] dark:border-white/10 dark:hover:border-white/25"
                  style={{ borderRadius: '28px' }}
                >
                  <div className="w-11 h-11 bg-[color:var(--sand)] border border-[color:var(--line)] flex items-center justify-center mb-4 dark:bg-[color:var(--paper)] dark:border-white/12" style={{ borderRadius: '16px' }}>
                    <Icon className="w-5 h-5 text-[color:var(--text-2)] dark:text-white/70" />
                  </div>
                  <div className="text-[color:var(--ink)] font-semibold mb-1 dark:text-white">{meta.label}</div>
                  <div className="text-xs text-[color:var(--text-2)] leading-relaxed dark:text-white/40">{meta.desc}</div>
                  <div className="mt-4 text-xs text-[color:var(--text-4)] dark:text-white/35">{counts[k]} available</div>
                </button>
              );
            })}
          </div>
      ...
      {/* Featured */}
      <section className="py-16 px-6 bg-[color:var(--sand)] dark:bg-[color:var(--paper)]">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-end justify-between mb-8">
            <div>
              <div className="text-[10px] font-semibold tracking-widest uppercase text-[color:var(--blue)] mb-2 dark:text-[color:var(--blue)]">Featured</div>
              <h2 className="text-2xl font-light text-[color:var(--ink)] dark:text-white">Handpicked by our team</h2>
            </div>
            <a href="#browse" className="text-sm text-[color:var(--text-2)] hover:text-[color:var(--ink)] flex items-center gap-1 dark:text-white/55 dark:hover:text-white">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {featured.map(item => {
              ...
              return (
                <div key={item.id} className="p-6 bg-[color:var(--paper)] border border-[color:var(--line)] hover:border-[color:var(--line)] transition-all dark:bg-[color:var(--paper)] dark:border-white/10 dark:hover:border-white/25" style={{ borderRadius: '28px' }}>
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-11 h-11 bg-[color:var(--blue-100)] border border-[color:var(--line)] flex items-center justify-center dark:bg-[color:var(--blue-100)] dark:border-[color:var(--line)]" style={{ borderRadius: '16px' }}>
                      <Icon className="w-5 h-5 text-[color:var(--blue)] dark:text-[color:var(--blue)]" />
                    </div>
                    <span className="text-[10px] font-semibold tracking-wide uppercase px-2 py-0.5 bg-[color:var(--blue-100)] text-[color:var(--blue)] dark:bg-[color:var(--blue-100)] dark:text-[color:var(--blue)]" style={{ borderRadius: '28px' }}>Official</span>
                  </div>
                  <div className="text-[color:var(--ink)] font-semibold mb-1.5 dark:text-white">{item.name}</div>
                  <p className="text-sm text-[color:var(--text-2)] leading-relaxed mb-5 dark:text-white/50">{item.tagline}</p>
                  <div className="flex items-center justify-between text-xs text-[color:var(--text-2)] dark:text-white/38">
      ...
      <section id="browse" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-light text-[color:var(--ink)] dark:text-white mb-3">Browse the hub</h2>
            <p className="text-[color:var(--text-2)] dark:text-white/45">Find exactly what fits your stack.</p>
          </div>
            ...
            {categories.map(c => (
              <button
                ...
                className={`px-3 py-1 text-[11px] font-medium transition-all duration-150 ${
                  category === c
                    ? 'bg-[color:var(--blue-100)] text-[color:var(--blue)] border border-[color:var(--line)] dark:bg-[color:var(--blue-100)] dark:text-[color:var(--blue)] dark:border-[color:var(--line)]'
                    : 'bg-transparent text-[color:var(--text-2)] border border-[color:var(--line)] hover:text-[color:var(--text-2)] hover:border-[color:var(--line)] dark:text-white/35 dark:border-white/10 dark:hover:text-white/65 dark:hover:border-white/20'
                }`}
                style={{ borderRadius: '28px' }}
              >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {filtered.map(item => {
                ...
                return (
                  <div
                    key={item.id}
                    className="group p-5 bg-[color:var(--paper)] border border-[color:var(--line)] hover:border-[color:var(--line)] hover:shadow-md transition-all cursor-pointer dark:bg-[color:var(--paper)] dark:border-white/10 dark:hover:border-white/25"
                    style={{ borderRadius: '16px' }}
                  >
                    <div className="flex items-start gap-3 mb-4">
                      <div className="w-10 h-10 bg-[color:var(--sand)] border border-[color:var(--line)] flex items-center justify-center flex-shrink-0 dark:bg-[color:var(--paper)] dark:border-white/12" style={{ borderRadius: '16px' }}>
                        <Icon className="w-5 h-5 text-[color:var(--text-2)] dark:text-white/70" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5 mb-0.5 flex-wrap">
                          <span className="text-[color:var(--ink)] font-semibold text-[15px] truncate dark:text-white">{item.name}</span>
                          {item.official && (
                            <span className="text-[9px] font-semibold tracking-wide uppercase px-1.5 py-0.5 bg-[color:var(--blue-100)] text-[color:var(--blue)] dark:bg-[color:var(--blue-100)] dark:text-[color:var(--blue)]" style={{ borderRadius: '28px' }}>Official</span>
                          )}
                          {item.verified && !item.official && (
                            <span className="text-[9px] font-semibold tracking-wide uppercase px-1.5 py-0.5 bg-[color:var(--sand)] text-[color:var(--text-2)] flex items-center gap-0.5 dark:bg-[color:var(--paper)] dark:text-white/55" style={{ borderRadius: '28px' }}>
                              <CheckCircle className="w-2.5 h-2.5" /> Verified
                            </span>
                          )}
                        </div>
                        <div className="text-[11px] text-[color:var(--text-2)] dark:text-white/38">by {item.author}</div>
                      </div>
                    </div>
                    <p className="text-[13px] text-[color:var(--text-2)] leading-relaxed mb-4 dark:text-white/50">{item.tagline}</p>
                    <div className="flex flex-wrap gap-1 mb-4">
                      {item.tags.slice(0, 3).map(tag => (
                        <span key={tag} className="text-[10px] font-medium px-2 py-0.5 bg-[color:var(--sand)] text-[color:var(--text-2)] dark:bg-[color:var(--paper)] dark:text-white/45" style={{ borderRadius: '28px' }}>
                          {tag}
                        </span>
                      ))}
                    </div>
                    <div className="flex items-center justify-between pt-3 border-t border-[color:var(--line)] text-[11px] text-[color:var(--text-2)] dark:border-white/8 dark:text-white/40">
      ...
      {/* Developer CTA */}
      <section id="publish" className="py-20 px-6 border-t border-[color:var(--line)] dark:border-white/8">
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[color:var(--sand)] border border-[color:var(--line)] text-[color:var(--text-2)] text-xs font-medium mb-5 dark:bg-[color:var(--paper)] dark:border-white/10 dark:text-white/50" style={{ borderRadius: '28px' }}>
                <Code className="w-3 h-3" />
                For developers
              </div>
              <h2 className="text-4xl font-light text-[color:var(--ink)] tracking-tight mb-5 dark:text-white">
                Ship a skill,<br /><span className="font-semibold">reach every team.</span>
              </h2>
              <p className="text-[color:var(--text-2)] leading-relaxed mb-8 dark:text-white/50">
                ...
                {[
                  ...
                  return (
                    <div key={i} className="flex items-start gap-3">
                      <div className="w-7 h-7 bg-[color:var(--sand)] flex items-center justify-center flex-shrink-0 mt-0.5 dark:bg-[color:var(--paper)]" style={{ borderRadius: '16px' }}>
                        <Icon className="w-3.5 h-3.5 text-[color:var(--text-2)] dark:text-white/60" />
                      </div>
                      <span className="text-sm text-[color:var(--text-2)] dark:text-white/60">{row.text}</span>
                    </div>
                  );
                })}
              </div>
            ...
            {/* Code preview */}
            <div className="bg-[#0f0e0c] p-6 shadow-2xl shadow-black/20 dark:shadow-black/60 overflow-hidden" style={{ borderRadius: '28px' }}>
              <div className="flex items-center gap-1.5 mb-4">
                <span className="w-2.5 h-2.5 bg-[#ff5f57]" style={{ borderRadius: '28px' }} />
                <span className="w-2.5 h-2.5 bg-[#febc2e]" style={{ borderRadius: '28px' }} />
                <span className="w-2.5 h-2.5 bg-[#28c840]" style={{ borderRadius: '28px' }} />
...
export default defineSkill({
  ...
  async run(ctx, { message }) {
    ...
    return ctx.route('sales-inbox');
      ...
      {/* How it works */}
      <section className="py-20 px-6 bg-[color:var(--sand)] dark:bg-[color:var(--paper)]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-light text-[color:var(--ink)] dark:text-white mb-3">From install to running in minutes</h2>
            <p className="text-[color:var(--text-2)] dark:text-white/45">Every capability on the hub follows the same install flow.</p>
          </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-[color:var(--text-2)] mb-10 dark:text-white/50">
