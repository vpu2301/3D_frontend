  ...
  return (
    <div className="min-h-screen pt-20 bg-gradient-to-b from-[color:var(--sand)] to-[color:var(--paper)] dark:from-[color:var(--bg)] dark:to-[color:var(--paper)]">
      ...
      <section className="py-20 px-4 bg-[color:var(--paper)] dark:bg-[color:var(--paper)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[color:var(--ink)] mb-6 dark:text-white">{t('solutions.finance.featuresTitle')}</h2>
            <p className="text-xl text-[color:var(--text-2)] max-w-3xl mx-auto dark:text-[color:var(--text-4)]">{t('solutions.finance.featuresSubtitle')}</p>
          </div>
      ...
      <section className="py-20 px-4 bg-[color:var(--sand)] dark:bg-[color:var(--bg)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-[color:var(--ink)] mb-6 dark:text-white">{t('solutions.finance.statsTitle')}</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: t('solutions.finance.s1Value'), label: t('solutions.finance.s1Label'), color: 'text-[color:var(--blue)]' },
              { value: t('solutions.finance.s2Value'), label: t('solutions.finance.s2Label'), color: 'text-[color:var(--blue)]' },
              { value: t('solutions.finance.s3Value'), label: t('solutions.finance.s3Label'), color: 'text-[color:var(--blue)]' },
              { value: t('solutions.finance.s4Value'), label: t('solutions.finance.s4Label'), color: 'text-[color:var(--ink)] dark:text-white' },
            ].map((stat, i) => (
          ...
          <div className="bg-[color:var(--paper)] rounded-[28px] p-12 text-[color:var(--ink)] border border-[color:var(--line)] dark:bg-[color:var(--sand)] dark:border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-[color:var(--text-2)] dark:text-white/60">{t('solutions.finance.e1Desc')}</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-[color:var(--text-2)] dark:text-white/60">{t('solutions.finance.e2Desc')}</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-[color:var(--text-2)] dark:text-white/60">{t('solutions.finance.e3Desc')}</p>
              </div>
            </div>
          </div>
        </div>
