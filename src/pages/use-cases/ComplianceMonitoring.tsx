  ...
  return (
    <div className="min-h-screen pt-20 bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-gray-900 mb-6">Why Automate Compliance Monitoring?</h2>
            <p className="text-xl text-gray-600">Protect your organization with proactive compliance management</p>
          </div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-gray-900 mb-6">Compliance Monitoring Features</h2>
            <p className="text-xl text-gray-600">Comprehensive tools for regulatory compliance</p>
          </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-gray-900 mb-6">Industry-Specific Compliance</h2>
            <p className="text-xl text-gray-600">Pre-built monitoring for major industry regulations</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {industries.map((industry, index) => (
              <div key={index} className="bg-gray-50 p-6 rounded-3xl">
                <h3 className="text-xl font-medium text-gray-900 mb-4">{industry.name}</h3>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-light text-gray-900 mb-6">Stay Compliant, Stay Secure</h2>
